class OsuSprite
{
	constructor(Layer,origin,path,Cordinates){
		this.x = Cordinates.x;
		this.y = Cordinates.y;
		this.path = path;
		this.layer = Layer;
		...
		this.cmds = [];
		this.move(Easing,startTime,EndTime,StartCords,EndCords)
		{
		...
		this.moveX(Easing,startTime,EndTime,StartCords,EndCords)
		{
		...
		this.moveY(Easing,startTime,EndTime,StartCords,EndCords)
		{
		...
		this.fade(Easing,startTime,EndTime,StartOpacity,EndOpacity)
		{
		...
		this.scale(Easing,startTime,EndTime,StartScale,EndScale)
		{
		...
		this.scaleV(Easing,startTime,EndTime,StartScale,EndScale)
		{
		...
		this.rotate(Easing,startTime,EndTime,StartRotate,EndRotate)
		{
		...
		this.color(Easing,startTime,EndTime,StartCords,EndCords)
		{
...
class OsuAnimation extends OsuSprite
{
		constructor(Layer,origin,path,Cordinates,frameCount,frameDur,loopForeverBool){
			super(Layer,origin,path,Cordinates);
			this.frameCount = frameCount;
			this.frameDur = frameDur;
			this.loopType = loopForeverBool ? "LoopForever" : "LoopOnce"
			this.declare = "Animation," + this.layer + "," + this.origin + "," + "\"" + this.path + "\"," + this.x + "," + this.y + "," + this.frameCount + "," + this.frameDur + "," + this.loopType;
