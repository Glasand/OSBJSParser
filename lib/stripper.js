...
document.getElementById("submit").onclick = function () {
  var inn = document.getElementById("code");
  editor.save();
  var code = document.getElementById("code").value;
  var StrippedCode = stripper.lex(inn.value).join("");
  
  var scriptTag = "function run(){" + StrippedCode + "}";
  var frame = document.getElementById('result'); 
  console.log(scriptTag);
  frame.contentWindow.postMessage(scriptTag, '*');
};
